...
usb_endpoint_in_t usb_endpoints_in[USB_ENDPOINT_IN_COUNT] = {
    ...
    [USB_ENDPOINT_IN_CODEX] = QMK_USB_ENDPOINT_IN(USB_EP_MODE_TYPE_INTR, CODEX_EPSIZE, CODEX_IN_EPNUM, RAW_IN_CAPACITY, NULL, QMK_USB_REPORT_STORAGE_DEFAULT(CODEX_EPSIZE)),
#endif
// clang-format off
...
#ifdef CODEX_HYBRID_ENABLE
    [CODEX_INTERFACE] = USB_ENDPOINT_IN_CODEX,
#endif
#if !defined(KEYBOARD_SHARED_EP)
...
#ifdef CODEX_HYBRID_ENABLE
    [USB_ENDPOINT_OUT_CODEX] = QMK_USB_ENDPOINT_OUT(USB_EP_MODE_TYPE_INTR, CODEX_EPSIZE, CODEX_OUT_EPNUM, RAW_OUT_CAPACITY),
#endif
#if defined(RAW_ENABLE)
