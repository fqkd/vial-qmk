...
// clang-format off
// phenom-micro-layout-v0.0.6: ADJUST F11/F12 fix; Vial geometry unchanged from v0.0.4.
...
KC_HOME,  KC_INS,   KC_DEL,   KC_END,   KC_ENT,                                           _______,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT,
...
_______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_F11,                                           KC_F12,   KC_VOLD,  KC_MUTE,  KC_VOLU,  _______,
_______,  _______,  _______,  _______,  _______,                                          _______,  _______,  _______,  _______,  _______,
    ...
    [_FOUR] = LAYOUT(
_______,  _______,  _______,  _______,  _______,                                          _______,  _______,  _______,  _______,  _______,
EH_SCR,   KC_BTN3,  KC_BTN2,  KC_BTN1,  EH_SNP,                                           EH_SNP,   KC_BTN1,  KC_BTN2,  KC_BTN3,  EH_SCR,
