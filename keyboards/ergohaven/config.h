...
#define KB_SETTINGS_LAYER_LABELS_SIZE (16 * 16)
#define KB_SETTINGS_LAYER_LABELS_OFFSET (KB_SETTINGS_RUEN_OFFSET + KB_SETTINGS_RUEN_SIZE)
#define KB_SETTINGS_LAYER_LABELS_PROTOS 16

#define EECONFIG_KB_DATA_SIZE (KB_SETTINGS_RUEN_SIZE + KB_SETTINGS_LAYER_LABELS_SIZE)
#define KB_SETTINGS_NPROTOS (KB_SETTINGS_RUEN_PROTOS + KB_SETTINGS_LAYER_LABELS_PROTOS)
